...
monsta_affinity_type('Legendary EmeraldHawkmon', Wind).
...
monsta_special_attack_name(Cobra, 'Cobra Constriction').
...
monsta_special_attack_name(MantaRaymon, 'Manta Burst').
